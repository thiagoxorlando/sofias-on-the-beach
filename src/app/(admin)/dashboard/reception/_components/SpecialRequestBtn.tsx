...
import { markSpecialRequestHandledAction } from '../actions'
  ...
  return (
    <div className="flex flex-col gap-1">
      <button
        ...
        onClick={handleClick}
        disabled={isPending}
        className="inline-flex items-center gap-1.5 text-[12px] font-semibold text-slate-700 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-xl px-3 py-1.5 transition-colors disabled:opacity-50"
      >
