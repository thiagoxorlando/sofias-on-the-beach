...
export function ReservationActions({ reservationId, status, checkInWarnings, checkOutWarnings }: { reservationId: string; status: string; checkInWarnings?: string[]; checkOutWarnings?: string[] }) {
  ...
  return (
    <div className="flex flex-col items-end gap-2.5">
      ...
      {status === 'checked_in' && checkOutWarnings && checkOutWarnings.length > 0 && (
        <ul className="w-full max-w-sm space-y-1 bg-amber-50 border border-amber-100 rounded-xl px-3.5 py-2.5">
