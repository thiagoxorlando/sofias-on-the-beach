...
export function Footer() {
  ...
  return (
    <footer className="bg-ocean-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-32 rounded-b-full bg-ocean-800/40" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 md:gap-12 pb-10 border-b border-ocean-800">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            {/* Logo mark + wordmark in white */}
            <div className="flex items-center gap-3 mb-5">
              <SofiasMark className="w-8 h-8 text-ocean-400" />
